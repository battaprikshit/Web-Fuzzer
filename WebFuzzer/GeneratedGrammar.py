...
UDef("action", Or("search.php?test=query"))
UDef("query",URef("searchFor"),URef("goButton"),sep='&')
UDef("searchFor", Or("searchFor"), URef("_xss_string"), sep="=")
UDef("goButton", Or("goButton"), Or("go"), sep="=")